...
const store = {
   ...
   * @param {number} minPrice - the minimum price of each item for list inclusion
  ...
  getTotalValue() {
    return inventory.reduce(
      (currentTotal, item) => item.price * item.quantity + currentTotal,
      0
    );
  },
};
